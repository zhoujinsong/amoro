...
public class TestIcebergServerTableDescriptor extends TestServerTableDescriptor {
  ...
  public void testOptimizingProcess() {
    ...
    Pair<List<OptimizingProcessInfo>, Integer> res =
        descriptor.getOptimizingProcessesInfo(table, null, null, 4, 4, null, null);
    ...
    res =
        descriptor.getOptimizingProcessesInfo(table, null, ProcessStatus.SUCCESS, 5, 0, null, null);
    ...
    res =
        descriptor.getOptimizingProcessesInfo(
            table, OptimizingType.MINOR.name(), null, 5, 0, null, null);
    ...
    res =
        descriptor.getOptimizingProcessesInfo(
            table, OptimizingType.MINOR.name(), ProcessStatus.SUCCESS, 2, 2, null, null);
