...
public class SparkInternalTable extends SparkTable {
  ...
  public SparkInternalTable(
      BasicUnkeyedTable basicUnkeyedTable, boolean refreshEagerly, boolean isChange) {
